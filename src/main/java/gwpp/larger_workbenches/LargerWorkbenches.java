package gwpp.larger_workbenches;
...
import gwpp.larger_workbenches.block.BlockAutoLargeWorkbench;
import gwpp.larger_workbenches.block.BlockLargeWorkbench;
import gwpp.larger_workbenches.block.ItemBlockLargeWorkbench;
import gwpp.larger_workbenches.gui.ContainerAutoLargeWorkbench4x4;
import gwpp.larger_workbenches.gui.ContainerAutoLargeWorkbench5x5;
import gwpp.larger_workbenches.gui.ContainerAutoLargeWorkbench6x6;
import gwpp.larger_workbenches.gui.ContainerAutoLargeWorkbench7x7;
import gwpp.larger_workbenches.gui.ContainerAutoLargeWorkbench8x8;
import gwpp.larger_workbenches.gui.ContainerAutoLargeWorkbench9x9;
import gwpp.larger_workbenches.gui.ContainerLargeWorkbench4x4;
import gwpp.larger_workbenches.gui.ContainerLargeWorkbench5x5;
import gwpp.larger_workbenches.gui.ContainerLargeWorkbench6x6;
import gwpp.larger_workbenches.gui.ContainerLargeWorkbench7x7;
import gwpp.larger_workbenches.gui.ContainerLargeWorkbench8x8;
import gwpp.larger_workbenches.gui.ContainerLargeWorkbench9x9;
import gwpp.larger_workbenches.gui.GuiAutoLargeWorkbench4x4;
import gwpp.larger_workbenches.gui.GuiAutoLargeWorkbench5x5;
import gwpp.larger_workbenches.gui.GuiAutoLargeWorkbench6x6;
import gwpp.larger_workbenches.gui.GuiAutoLargeWorkbench7x7;
import gwpp.larger_workbenches.gui.GuiAutoLargeWorkbench8x8;
import gwpp.larger_workbenches.gui.GuiAutoLargeWorkbench9x9;
import gwpp.larger_workbenches.gui.GuiLargeWorkbench4x4;
import gwpp.larger_workbenches.gui.GuiLargeWorkbench5x5;
import gwpp.larger_workbenches.gui.GuiLargeWorkbench6x6;
import gwpp.larger_workbenches.gui.GuiLargeWorkbench7x7;
import gwpp.larger_workbenches.gui.GuiLargeWorkbench8x8;
import gwpp.larger_workbenches.gui.GuiLargeWorkbench9x9;
import gwpp.larger_workbenches.plugin.minetweaker.TweakerPlugin;
...
import gwpp.larger_workbenches.tileentity.TileEntityLargeWorkbench5x5;
import gwpp.larger_workbenches.tileentity.TileEntityLargeWorkbench6x6;
import gwpp.larger_workbenches.tileentity.TileEntityLargeWorkbench7x7;
import gwpp.larger_workbenches.tileentity.TileEntityLargeWorkbench8x8;
...
public class LargerWorkbenches {
	...
	public static final String MODID = "GW:PPWorkbenches";
	public static final String MODNAME = "GW:PP Workbenches";
	...
	private static void registerInfo(ModMetadata meta) {
		...
		meta.url = "https://github.com/GWPlusPlus/GWPPWorkbenches";
		meta.authorList.add("GW:PP");
